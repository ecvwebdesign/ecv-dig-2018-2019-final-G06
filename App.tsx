...
TestFairy.begin("f0b00503ef806f4231ef4cbff1838b749f972558");
    ...
    return (
      ...
      return (
        <Onboarding
          ...
          onSkip={() => this.setState({onDoneBoarding: true})}
          ...
          pages={[
            ...
            {
              backgroundColor: '#fff',
              image: <Image source={require('./src/assets/img/boarding/pattern-yuno-page-scan2.png')} style={{position: 'absolute', top: -150, left:0, zIndex: -1, flex: 1, width: '100%', resizeMode: 'cover'}} />,
              title: <View>
